...
//gameloop....ctime = current time
function main(ctime){
    window.requestAnimationFrame(main);
    //console.log(ctime); //high_speed
...
function gameEngine(){
    ...
    // if you have eatan the food, increment the food and regenerate the food
    if(snakeArr[0].y===food.y && snakeArr[0].x===food.x)
    {
        ...
        if(score>hiscoreeval)
        {
            ...
            hiscoreBox.innerHTML="HighScore : "+hiscoreeval;
        }
